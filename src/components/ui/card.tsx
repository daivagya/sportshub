...
const colorThemes: Record<string, string> = {
  green:
    "bg-gradient-to-br from-green-50 to-green-100 border-green-100 text-green-700",
  blue: "bg-gradient-to-br from-blue-50 to-blue-100 border-blue-100 text-blue-700",
  yellow:
    "bg-gradient-to-br from-yellow-50 to-yellow-100 border-yellow-100 text-yellow-700",
  pink: "bg-gradient-to-br from-pink-50 to-pink-100 border-pink-100 text-pink-700",
  default:
    "bg-gradient-to-br from-white to-gray-50 border-gray-100 text-gray-700",
};
...
const CardDescription = React.forwardRef<
  ...
  React.HTMLAttributes<HTMLParagraphElement>
>(({ className, ...props }, ref) => (
  <p ref={ref} className={cn("text-sm opacity-75", className)} {...props} />
));
...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "flex items-center justify-end p-4 border-t border-gray-100",
      className
    )}
    {...props}
  />
